...
which the paper's numbering gives to `nativecmp_compareInteractions_count` - a different
quantity - while the strength figure is Fig. 2. The route for the `how_much_total` need
